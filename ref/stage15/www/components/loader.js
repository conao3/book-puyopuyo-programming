...
(function () {
  ...
  if (
    ...
    (navigator.userAgent.match(/MSIE\s10.0/) &&
...
(function () {
  ...
  monaca.showSpinner = function (options) {
    ...
    var backgroundOpacity =
      options.backgroundOpacity != null ? options.backgroundOpacity : null;
    var title = options.title ? options.title : null;
    var titleColor = options.titleColor ? options.titleColor : null;
    var titleFontScale =
      options.titleFontScale != null ? options.titleFontScale : null;
    monaca.apiQueue.exec(
      null,
      null,
      'mobi.monaca.nativecomponent',
